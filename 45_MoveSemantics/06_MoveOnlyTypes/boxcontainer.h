...
public:
    ...
    BoxContainer(const BoxContainer<T>& container) = delete;
    BoxContainer(BoxContainer<T>&& container);
    ~BoxContainer();   
    ...
    void operator=(const BoxContainer<T>& source) = delete;
    // Move assignment operator
    /* This will be triggered if we try to assign a tmp copy */
