...
int main(){
    ...
    compare_T<std::string> my_comparator2{larger_in_size};

    std::cout << "best through my comparator 2: " 
        << get_best<std::string>(box, my_comparator2) << std::endl;

    // Smaller example
    std::cout << std::endl;
    std::cout << "Using templated callbacks : " << std::endl;
    std::cout << "smaller : " << get_best(box, smaller) << std::endl;
