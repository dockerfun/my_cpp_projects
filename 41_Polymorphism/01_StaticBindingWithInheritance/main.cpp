/**
 * Polymorphism: Managing derived objects in memory through base pointers
 * or references and getting the right method called on the base pointer or reference.
*/
